...
set VERSION=%1
set IMAGE_NAME=hbr.sinomach-he.cn:12345/mom-prod/web-basic-service:%VERSION%
...
rem Execute npm build:prod command
echo Running build:prod command...
call npm run build:prod
if !errorlevel! neq 0 (
    echo Error: npm build:prod failed
    exit /b 1
)
