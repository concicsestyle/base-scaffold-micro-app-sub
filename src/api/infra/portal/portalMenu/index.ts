...
export const listMenu = (query?: MenuQuery): AxiosPromise<MenuVO[]> => {
  return request({
    url: 'infra/admin/portal/menu/list',
    method: 'get',
    params: query
  });
};
...
export const getMenu = (menuId: string | number): AxiosPromise<MenuVO> => {
  return request({
    url: 'infra/admin/portal/menu/' + menuId,
    method: 'get'
  });
};
...
export const treeselect = (): AxiosPromise<MenuTreeOption[]> => {
  return request({
    url: 'infra/admin/portal/menu/treeselect',
    method: 'get'
  });
};
...
export const roleMenuTreeselect = (roleId: string | number): AxiosPromise<RoleMenuTree> => {
  return request({
    url: 'infra/admin/portal/menu/roleMenuTreeselect/' + roleId,
    method: 'get'
  });
};
...
export const tenantPackageMenuTreeselect = (packageId: string | number): AxiosPromise<RoleMenuTree> => {
  return request({
    url: 'infra/admin/portal/menu/tenantPackageMenuTreeselect/' + packageId,
    method: 'get'
  });
};
