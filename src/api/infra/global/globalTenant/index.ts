...
export function listTenant(query: TenantQuery): AxiosPromise<TenantVO[]> {
  return request({
    url: '/infra/admin/global/tenant/list',
    method: 'get',
    params: query
  });
}
...
export function getTenant(id: string | number): AxiosPromise<TenantVO> {
  return request({
    url: '/infra/admin/global/tenant/' + id,
    method: 'get'
  });
}
...
export function changeTenantStatus(id: string | number, tenantId: string | number, status: string) {
  ...
  return request({
    url: '/infra/admin/global/tenant/changeStatus',
    method: 'put',
    data: data
  });
}
...
export function dynamicTenant(tenantId: string | number) {
  return request({
    url: '/infra/admin/global/tenant/dynamic/' + tenantId,
    method: 'get'
  });
}
...
export function dynamicClear() {
  return request({
    url: '/infra/admin/global/tenant/dynamic/clear',
    method: 'get'
  });
}
...
export function syncTenantPackage(tenantId: string | number, packageId: string | number) {
  ...
  return request({
    url: '/infra/admin/global/tenant/syncTenantPackage',
    method: 'get',
    params: data
  });
}
...
export function syncTenantDict() {
  return request({
    url: '/infra/admin/global/tenant/syncTenantDict',
    method: 'get'
  });
}
