...
export function getDicts(dictType: string): AxiosPromise<DictDataVO[]> {
  return request({
    url: 'infra/admin/common/dictData/type/' + dictType,
    method: 'get'
  });
}
...
export function listData(query: DictDataQuery): AxiosPromise<DictDataVO[]> {
  return request({
    url: 'infra/admin/common/dictData/list',
    method: 'get',
    params: query
  });
}
...
export function getData(dictCode: string | number): AxiosPromise<DictDataVO> {
  return request({
    url: 'infra/admin/common/dictData/' + dictCode,
    method: 'get'
  });
}
...
export function addData(data: DictDataForm) {
  return request({
    url: 'infra/admin/common/dictData',
    method: 'post',
    data: data
  });
}
