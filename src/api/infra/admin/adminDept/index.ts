...
export const listDept = (query?: DeptQuery) => {
  return request({
    url: 'infra/admin/admin/dept/list',
    method: 'get',
    params: query
  });
};
...
export const listDeptExcludeChild = (deptId: string | number): AxiosPromise<DeptVO[]> => {
  return request({
    url: 'infra/admin/admin/dept/list/exclude/' + deptId,
    method: 'get'
  });
};
...
export const getDept = (deptId: string | number): AxiosPromise<DeptVO> => {
  return request({
    url: 'infra/admin/admin/dept/' + deptId,
    method: 'get'
  });
};
...
export const treeselect = (): AxiosPromise<DeptTreeVO[]> => {
  return request({
    url: 'infra/admin/admin/dept/treeselect',
    method: 'get'
  });
};
