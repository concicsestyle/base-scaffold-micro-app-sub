...
export const importTable = (data: { tables: string; dataName: string }): AxiosPromise<GenTableVO> => {
  return request({
    url: '/infra/admin/gen/importTable',
    method: 'post',
    params: data
  });
};
...
export const previewTable = (tableId: string | number) => {
  return request({
    url: '/infra/admin/gen/preview/' + tableId,
    method: 'get'
  });
};
...
export const genCode = (tableId: string | number) => {
  return request({
    url: '/infra/admin/gen/genCode/' + tableId,
    method: 'get'
  });
};
...
export const synchDb = (tableId: string | number) => {
  return request({
    url: '/infra/admin/gen/synchDb/' + tableId,
    method: 'get'
  });
};
...
export const getDataNames = () => {
  return request({
    url: '/infra/admin/gen/getDataNames',
    method: 'get'
  });
};
