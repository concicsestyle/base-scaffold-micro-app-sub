...
import { FlowInstanceQuery, FlowInstanceVO } from '@/api/workflow/admin/instance/types';
...
export const pageByRunning = (query: FlowInstanceQuery): AxiosPromise<FlowInstanceVO[]> => {
  return request({
    url: '/workflow/admin/instance/pageByRunning',
    method: 'get',
    params: query
  });
};
...
export const pageByFinish = (query: FlowInstanceQuery): AxiosPromise<FlowInstanceVO[]> => {
  return request({
    url: '/workflow/admin/instance/pageByFinish',
    method: 'get',
    params: query
  });
};
...
export const pageByCurrent = (query: FlowInstanceQuery): AxiosPromise<FlowInstanceVO[]> => {
  return request({
    url: '/workflow/admin/instance/pageByCurrent',
    method: 'get',
    params: query
  });
};
...
export const cancelProcessApply = (data: any) => {
  return request({
    url: `/workflow/admin/instance/cancelProcessApply`,
    method: 'put',
    data: data
  });
};
...
export const instanceVariable = (instanceId: string | number) => {
  return request({
    url: `/workflow/admin/instance/instanceVariable/${instanceId}`,
    method: 'get'
  });
};
...
export const deleteByInstanceIds = (instanceIds: Array<string | number> | string | number) => {
  return request({
    url: `/workflow/admin/instance/deleteByInstanceIds/${instanceIds}`,
    method: 'delete'
  });
};
/**
...
export const invalid = (data: any) => {
  return request({
    url: `/workflow/admin/instance/invalid`,
    method: 'post',
    data: data
  });
};
