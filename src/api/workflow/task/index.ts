...
import { TaskQuery, FlowTaskVO, TaskOperationBo } from '@/api/workflow/admin/task/types';
...
export const pageByTaskWait = (query: TaskQuery): AxiosPromise<FlowTaskVO[]> => {
  return request({
    url: '/workflow/admin/task/pageByTaskWait',
    method: 'get',
    params: query
  });
};
...
export const pageByTaskFinish = (query: TaskQuery): AxiosPromise<FlowTaskVO[]> => {
  return request({
    url: '/workflow/admin/task/pageByTaskFinish',
    method: 'get',
    params: query
  });
};
...
export const pageByTaskCopy = (query: TaskQuery): AxiosPromise<FlowTaskVO[]> => {
  return request({
    url: '/workflow/admin/task/pageByTaskCopy',
    method: 'get',
    params: query
  });
};
...
export const pageByAllTaskWait = (query: TaskQuery): AxiosPromise<FlowTaskVO[]> => {
  return request({
    url: '/workflow/admin/task/pageByAllTaskWait',
    method: 'get',
    params: query
  });
};
...
export const pageByAllTaskFinish = (query: TaskQuery): AxiosPromise<FlowTaskVO[]> => {
  return request({
    url: '/workflow/admin/task/pageByAllTaskFinish',
    method: 'get',
    params: query
  });
};
...
export const startWorkFlow = (data: object): any => {
  return request({
    url: '/workflow/admin/task/startWorkFlow',
    method: 'post',
    data: data
  });
};
...
export const completeTask = (data: object) => {
  return request({
    url: '/workflow/admin/task/completeTask',
    method: 'post',
    data: data
  });
};
...
export const backProcess = (data: any): any => {
  return request({
    url: '/workflow/admin/task/backProcess',
    method: 'post',
    data: data
  });
};
...
export const getTask = (taskId: string) => {
  return request({
    url: '/workflow/admin/task/getTask/' + taskId,
    method: 'get'
  });
};
...
export const updateAssignee = (taskIdList: Array<string>, userId: string) => {
  return request({
    url: `/workflow/admin/task/updateAssignee/${userId}`,
    method: 'put',
    data: taskIdList
  });
};
...
export const terminationTask = (data: any) => {
  return request({
    url: `/workflow/admin/task/terminationTask`,
    method: 'post',
    data: data
  });
};
...
export const getBackTaskNode = (definitionId: string, nodeCode: string) => {
  return request({
    url: `/workflow/admin/task/getBackTaskNode/${definitionId}/${nodeCode}`,
    method: 'get'
  });
};
...
export const taskOperation = (data: TaskOperationBo, operation: string) => {
  return request({
    url: `/workflow/admin/task/taskOperation/${operation}`,
    method: 'post',
    data: data
  });
};
...
export const currentTaskAllUser = (taskId: string | number) => {
  return request({
    url: `/workflow/admin/task/currentTaskAllUser/${taskId}`,
    method: 'get'
  });
};
...
export const getNextNodeList = (data: any): any => {
  return request({
    url: '/workflow/admin/task/getNextNodeList',
    method: 'post',
    data: data
  });
};
