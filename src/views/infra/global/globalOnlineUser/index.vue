        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="强退" placement="top">
              <el-button v-hasPermi="['adminGlobal:onlineUser:forceLogout']" link type="primary" icon="Delete" @click="handleForceLogout(scope.row)">
              </el-button>
            </el-tooltip>
          </template>
        </el-table-column>
...
import { forceLogout, list as initData } from '@/api/infra/global/globalOnlineUser';
import { OnlineQuery, OnlineVO } from '@/api/infra/global/globalOnlineUser/types';
