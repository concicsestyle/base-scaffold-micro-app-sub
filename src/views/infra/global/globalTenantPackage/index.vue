    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminGlobal:tenantPackage:add']" type="primary" plain icon="Plus" @click="handleAdd"> 新增 </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminGlobal:tenantPackage:edit']" type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()">
              修改
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              v-hasPermi="['adminGlobal:tenantPackage:remove']"
              type="danger"
              plain
              icon="Delete"
              :disabled="multiple"
          ...
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminGlobal:tenantPackage:export']" type="warning" plain icon="Download" @click="handleExport">导出 </el-button>
          </el-col>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermi="['adminGlobal:tenantPackage:edit']" link type="primary" icon="Edit" @click="handleUpdate(scope.row)"></el-button>
            </el-tooltip>
...
import {
  ...
  updateTenantPackage,
  changePackageStatus
} from '@/api/infra/global/globalTenantPackage';
import { treeselect as menuTreeselect, tenantPackageMenuTreeselect } from '@/api/infra/admin/adminMenu';
import { TenantPkgForm, TenantPkgQuery, TenantPkgVO } from '@/api/infra/global/globalTenantPackage/types';
import { MenuTreeOption } from '@/api/infra/admin/adminMenu/types';
...
const handleExport = () => {
  proxy?.download(
    'infra/admin/global/tenantPackage/export',
    {
      ...queryParams.value
    },
