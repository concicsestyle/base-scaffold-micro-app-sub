...
import { getAuthRole, updateAuthRole } from '@/api/infra/portal/portalUser';
import { UserForm } from '@/api/infra/portal/portalUser/types';
...
const close = () => {
  ...
  const obj: RouteLocationNormalized = {
    ...
    path: source ? '/portalManage/portalUserManage' : '/portalManage/portalUserManage'
  };
