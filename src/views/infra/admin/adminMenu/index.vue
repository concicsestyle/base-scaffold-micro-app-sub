  ...
  <div class="p-2">
    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10">
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminAdmin:menu:add']" type="primary" plain icon="Plus" @click="handleAdd()">新增 </el-button>
          </el-col>
          <el-col :span="1.5">
      ...
      >
        ...
        <el-table-column prop="path" label="路由地址" align="center" :show-overflow-tooltip="true"></el-table-column>
        ...
        <el-table-column prop="visible" label="显示状态" align="center" width="80">
          <template #default="scope">
            <dict-tag :options="menu_show_hide_status" :value="scope.row.visible" />
          </template>
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="180">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermi="['adminAdmin:menu:edit']" link type="primary" icon="Edit" @click="handleUpdate(scope.row)" />
            </el-tooltip>
            <el-tooltip content="新增" placement="top">
              <el-button v-hasPermi="['adminAdmin:menu:add']" link type="primary" icon="Plus" @click="handleAdd(scope.row)" />
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button v-hasPermi="['adminAdmin:menu:remove']" link type="primary" icon="Delete" @click="handleDelete(scope.row)" />
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" destroy-on-close center draggable append-to-bod width="600px">
        ...
        <el-row>
          ...
          <el-col v-if="form.menuType === 'C'" :span="12">
            <el-form-item prop="component">
              <template #label>
                <span>
                  <el-tooltip content="访问的组件路径，如：`infra/admin/adminUser/index`，默认在`views`目录下" placement="top">
                    <el-icon>
                      <question-filled />
                    </el-icon>
                  </el-tooltip>
          ...
          <el-col v-if="form.menuType !== 'M'" :span="12">
            <el-form-item>
              ...
              <template #label>
                <span>
                  <el-tooltip content="控制器中定义的权限字符，如：@SaCheckPermission('adminAdmin:user:list')" placement="top">
                    <el-icon>
                      <question-filled />
                    </el-icon>
                  </el-tooltip>
          ...
          <el-col v-if="form.menuType !== 'F'" :span="12">
            <el-form-item>
              ...
              <el-radio-group v-model="form.visible">
                <el-radio v-for="dict in menu_show_hide_status" :key="dict.value" :label="dict.value">{{ dict.label }} </el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item>
              ...
              <el-radio-group v-model="form.status">
                <el-radio v-for="dict in normal_disable" :key="dict.value" :label="dict.value">
                  {{ dict.label }}
                </el-radio>
              </el-radio-group>
            </el-form-item>
...
import { addMenu, cascadeDelMenu, delMenu, getMenu, listMenu, updateMenu } from '@/api/infra/admin/adminMenu';
import { MenuForm, MenuQuery, MenuVO } from '@/api/infra/admin/adminMenu/types';
...
const { menu_show_hide_status, normal_disable } = toRefs<any>(proxy?.useDict('menu_show_hide_status', 'normal_disable'));
