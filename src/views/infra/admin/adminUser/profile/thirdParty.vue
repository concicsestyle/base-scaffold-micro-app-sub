  ...
  <div>
    ...
    <div id="git-user-binding">
      ...
      <div id="authlist" class="user-bind">
        <a class="third-app" href="#" title="使用 基础平台 账号授权登录" @click="authUrl('pc_base_platform')">
          <div class="git-other-login-icon">
            <svg-icon icon-class="social-base-platform" />
          </div>
          <span class="app-name">基础平台</span>
        </a>
      </div>
    </div>
  </div>
...
import { authUnlock, authBinding } from '@/api/infra/admin/adminSocial/auth';
