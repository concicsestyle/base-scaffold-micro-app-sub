...
import { getAuthRole, updateAuthRole } from '@/api/infra/admin/adminUser';
import { UserForm } from '@/api/infra/admin/adminUser/types';
...
const close = () => {
  ...
  const obj: RouteLocationNormalized = {
    ...
    path: source ? '/adminManage/adminUserManage' : '/adminManage/adminUserManage'
  };
