        ...
        <el-card shadow="hover">
          <template #header>
            <el-row :gutter="10" class="mb8">
              <el-col :span="1.5">
                <el-button v-hasPermi="['adminAdmin:post:add']" type="primary" plain icon="Plus" @click="handleAdd">新增</el-button>
              </el-col>
              <!--              <el-col :span="1.5">-->
              <!--                <el-button v-hasPermi="['adminAdmin:post:edit']" type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()"-->
              <!--                  >修改</el-button-->
              <!--                >-->
              <!--              </el-col>-->
              <el-col :span="1.5">
                <el-button v-hasPermi="['adminAdmin:post:remove']" type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()">
                  删除
                </el-button>
              </el-col>
              <!--              <el-col :span="1.5">-->
              <!--                <el-button v-hasPermi="['adminAdmin:post:export']" type="warning" plain icon="Download" @click="handleExport">导出</el-button>-->
              <!--              </el-col>-->
              <right-toolbar v-model:showSearch="showSearch" @query-table="getList"></right-toolbar>
            </el-row>
          </template>
          <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange" border height="600">
            ...
            <el-table-column label="操作" width="180" align="center" class-name="small-padding fixed-width">
              <template #default="scope">
                <el-tooltip content="修改" placement="top">
                  <el-button v-hasPermi="['adminAdmin:post:edit']" link type="primary" icon="Edit" @click="handleUpdate(scope.row)"></el-button>
                </el-tooltip>
                <el-tooltip content="删除" placement="top">
                  <el-button v-hasPermi="['adminAdmin:post:remove']" link type="primary" icon="Delete" @click="handleDelete(scope.row)"></el-button>
                </el-tooltip>
              </template>
            </el-table-column>
          </el-table>
...
import { listPost, addPost, delPost, getPost, updatePost } from '@/api/infra/admin/adminPost';
import { PostForm, PostQuery, PostVO } from '@/api/infra/admin/adminPost/types';
import { DeptVO, DeptTreeVO } from '@/api/infra/admin/adminDept/types';
