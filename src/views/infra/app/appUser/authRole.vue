...
import { getAuthRole, updateAuthRole } from '@/api/infra/app/appUser';
import { UserForm } from '@/api/infra/app/appUser/types';
...
const close = () => {
  ...
  const obj: RouteLocationNormalized = {
    ...
    path: source ? '/appManage/appUserManage' : '/appManage/appUserManage'
  };
