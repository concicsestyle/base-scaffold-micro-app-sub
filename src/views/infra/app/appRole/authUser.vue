  ...
  <div class="p-2">
    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10">
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminApp:role:add']" type="primary" plain icon="Plus" @click="openSelectUser">添加用户</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminApp:role:remove']" type="danger" plain icon="CircleClose" :disabled="multiple" @click="cancelAuthUserAll">
              批量取消授权
            </el-button>
          </el-col>
          <el-col :span="1.5">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="取消授权" placement="top">
              <el-button v-hasPermi="['adminApp:role:remove']" link type="primary" icon="CircleClose" @click="cancelAuthUser(scope.row)"> </el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
import { allocatedUserList, authUserCancel, authUserCancelAll } from '@/api/infra/app/appRole';
import { UserQuery } from '@/api/infra/app/appUser/types';
...
const handleClose = () => {
  ...
  const obj: RouteLocationNormalized = {
    path: source ? '/appManage/appRoleManage' : '/appManage/appRoleManage',
    fullPath: '',
    hash: '',
    matched: [],
    meta: undefined,
