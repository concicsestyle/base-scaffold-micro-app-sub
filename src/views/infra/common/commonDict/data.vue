    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminCommon:dictData:add']" type="primary" plain icon="Plus" @click="handleAdd">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminCommon:dictData:edit']" type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()"
              >修改</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminCommon:dictData:remove']" type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()">
              删除
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-hasPermi="['adminCommon:dictData:export']" type="warning" plain icon="Download" @click="handleExport">导出</el-button>
          </el-col>
          <el-col :span="1.5">
      ...
      <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
        ...
        <el-table-column v-hasPermi="['adminCommon:dictData:edit']" label="操作" align="center" width="160" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermi="['adminCommon:dictData:edit']" link type="primary" icon="Edit" @click="handleUpdate(scope.row)"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button v-hasPermi="['adminCommon:dictData:remove']" link type="primary" icon="Delete" @click="handleDelete(scope.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
import { optionselect as getDictOptionselect, getType } from '@/api/infra/common/commonDict/type';
import { listData, getData, delData, addData, updateData } from '@/api/infra/common/commonDict/data';
...
const handleClose = () => {
  ...
  const obj: RouteLocationNormalized = {
    ...
    path: source ? '/infra/commonDictManage' : '/infra/commonDictManage'
  };
...
const handleExport = () => {
  proxy?.download(
    'infra/admin/common/dictData/export',
    {
      ...queryParams.value
    },
