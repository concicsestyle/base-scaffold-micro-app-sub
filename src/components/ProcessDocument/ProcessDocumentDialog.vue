<template>
    <div class="bt-page" :class="{'fullscreen': isFullScreen}">
     <el-button @click="fullScreen(!isFullScreen)">{{isFullScreen?'退出全屏':'全屏'}}</el-button>
     <el-popover :visible="visible"  trigger="click" placement="bottom" :width="300">
         <div class="box_left" :class="{
             'box_left_full': isFullScreen
         }">
