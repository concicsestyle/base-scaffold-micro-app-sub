        ...
        <el-col :lg="20" :xs="24">
          ...
          <el-card shadow="hover">
            ...
            >
              ...
              <vxe-column key="phone" title="手机号码" align="center" field="phone" width="120" />
              <vxe-column key="status" title="状态" align="center">
                <template #default="scope">
                  <dict-tag :options="normal_disable" :value="scope.row.status"></dict-tag>
                </template>
              </vxe-column>
...
import { UserQuery, UserVO } from '@/api/infra/admin/adminUser/types';
